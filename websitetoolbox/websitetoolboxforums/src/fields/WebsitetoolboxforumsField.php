...
namespace websitetoolbox\websitetoolboxforums\fields;

use websitetoolbox\websitetoolboxforums\Websitetoolboxforums;
use websitetoolbox\websitetoolboxforums\assetbundles\websitetoolboxforumsfieldfield\WebsitetoolboxforumsFieldFieldAsset;
...
/**
 * WebsitetoolboxforumsField Field
 *
 ...
 * @since     1.0.0
 */
class WebsitetoolboxforumsField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('websitetoolboxforums', 'WebsitetoolboxforumsField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'websitetoolboxforums/_components/fields/WebsitetoolboxforumsField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(WebsitetoolboxforumsFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').WebsitetoolboxforumsWebsitetoolboxforumsField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'websitetoolboxforums/_components/fields/WebsitetoolboxforumsField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
