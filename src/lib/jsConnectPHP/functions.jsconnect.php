<?php
/**
 * This file contains the client code for Websitetoolbox jsConnect single sign on.
 *
 * @author Todd Burry <todd@websitetoolboxforums.com>
 * @version 2.0
 * @copyright 2008-2017 Websitetoolbox Forums, Inc.
